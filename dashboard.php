...
<head>
    ...
    <title>WMA Admin Dashboard</title>
                    ...
                    <div class="card-body pb-0">
                        <div class="dropdown float-right">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton2">
                                <div class="dropdown-menu-content">
                                    <a class="dropdown-item" href="manage-dsign.php">Action</a>
                                    
                                </div>
                            </div>
                        </div>
                        <?php $query1=mysqli_query($con,"Select * from  tbldsign");
$totalcomp=mysqli_num_rows($query1);
?>
                        <h4 class="mb-0">
                            <span class="count"><?php echo $totalcomp;?></span>
                        </h4>
                        <p class="text-light">Total Designation</p>
