...
<head>
    ...
    <title>WMA Forgot Password</title>
...
<body class="bg-dark" style=" background-image: url('images/bg.jpg');background-size: cover;">
    ...
    <div class="sufee-login d-flex align-content-center flex-wrap">
        <div class="container">
            <div class="login-content">
                ...
                <h3 style="color: white">We Make Artist - Reset -Password </h3>
                    <hr  color="red"/>
                </div>
